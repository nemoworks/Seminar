...
\begin{frame}
    ...
    \begin{block}{Requirments}
        \begin{itemize}
            ...
            \item Duplicate indexes need to be merged. Maximize $p(s_i = s_j)$
    ...
    \begin{block}{Algorithm}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    \item randomly let $S = S_{d1}$ in probability of $\frac{n_1}{n_2}$
...
\begin{frame}
    ...
    \begin{block}{Problem}
        \begin{equation}
            \begin{aligned}
                (p_1(S_{d1}) = 1-\frac{n_i}{n_1}) > (p_2{S_i} = \frac{n_i}{n_2}) \\
            \end{aligned}
        \end{equation}
    \end{block}
    \begin{block}{Approach}
